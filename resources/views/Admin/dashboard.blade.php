    ...
    <aside class="w-64 bg-[#14171d] border-r border-gray-800 flex flex-col justify-between">
        <div>
            ...
            <nav class="p-4 space-y-1">
                <a href="#"
                    class="flex items-center gap-3 bg-[#1e232d] text-white px-4 py-3 rounded-lg font-medium transition">
    ...
    <main class="flex-1 overflow-y-auto">
        ...
        <div class="p-8 max-w-7xl mx-auto space-y-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <button
                    class="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white px-6 py-2.5 rounded-lg font-medium flex items-center gap-2 transition shadow-lg shadow-blue-500/20">
                    <span class="text-xl leading-none">+</span> Tambah Modul
                </button>
            </div>
            ...
            <div class="bg-[#14171d] rounded-2xl border border-gray-800 overflow-hidden">
                <div class="p-6 border-b border-gray-800 flex justify-between items-center">
                    ...
                    <a href="#" class="text-blue-400 hover:text-blue-300 text-sm flex items-center gap-1 transition">
