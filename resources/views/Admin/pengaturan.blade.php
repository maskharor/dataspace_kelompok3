            ...
            <div class="max-w-4xl mx-auto space-y-8">
                ...
                <div class="bg-[#14171d] rounded-2xl border border-gray-800 overflow-hidden">
                    <div class="p-6 border-b border-gray-800">
                        ...
                        <p class="text-gray-500 text-sm mt-1">Perbarui foto profil dan detail informasi Anda di sini.
                        </p>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="email" value="admin@dataspace.id"
                                    class="w-full px-4 py-2.5 bg-[#1e232d] border border-gray-700 rounded-xl text-white text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-[#181b22] border-t border-gray-800 flex justify-end">
                        <button
                            class="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white px-5 py-2 rounded-lg text-sm font-medium transition shadow-lg shadow-blue-500/20">Simpan
                            Profil</button>
                    </div>
                </div>
                ...
                <div class="bg-[#14171d] rounded-2xl border border-gray-800 overflow-hidden">
                    <div class="p-6 border-b border-gray-800">
                        ...
                        <p class="text-gray-500 text-sm mt-1">Pastikan akun Anda menggunakan password yang panjang dan
                            acak.</p>
                    </div>

                    <div class="p-6 space-y-5">
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-1.5">Password Saat Ini</label>
                            <input type="password"
                                class="w-full px-4 py-2.5 bg-[#1e232d] border border-gray-700 rounded-xl text-white text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition">
                        </div>
                        <div>
                    ...
                    <div class="p-4 bg-[#181b22] border-t border-gray-800 flex justify-end">
                        <button
                            class="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-400 hover:to-indigo-400 text-white px-5 py-2 rounded-lg text-sm font-medium transition shadow-lg shadow-blue-500/20">Perbarui
                            Password</button>
                    </div>
                </div>
